...
public class TelaMenu extends JFrame {
	...
	public TelaMenu() {
		...
		ImageIcon imgEstoque = new ImageIcon(new ImageIcon("img/estoque.png").getImage().getScaledInstance(125, 125, Image.SCALE_DEFAULT));
		...
		ImageIcon imgVenda = new ImageIcon(new ImageIcon("img/venda.png").getImage().getScaledInstance(125, 125, Image.SCALE_DEFAULT));
